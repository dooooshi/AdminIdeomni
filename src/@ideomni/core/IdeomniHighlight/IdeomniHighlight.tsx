 ...
 */
function IdeomniHighlight(props: IdeomniHighlightProps) {
			...
			{copy && (
				...
				>
					<Button
						...
						startIcon={<IdeomniSvgIcon size={16}>heroicons-outline:clipboard</IdeomniSvgIcon>}
					>
						Copy
					</Button>
				</Tooltip>
...
function trimCode(children: IdeomniHighlightProps['children']) {
	...
	// can be formatted properly while using Ideomni-highlight
	// component
...
const StyledIdeomniHighlight = styled(IdeomniHighlight)`` as unknown as typeof IdeomniHighlight;

export default StyledIdeomniHighlight;
