...
export type IdeomniScrollbarsProps = {
	id?: string;
	className?: string;
	children?: ReactNode;
	enable?: boolean;
...
function IdeomniScrollbars(props: IdeomniScrollbarsProps) {
	const {
		className = '',
		children,
		id = '',
	...
	const hookUpEvents = useCallback(() => {
		Object.keys(handlerNameByEvent).forEach((key) => {
			const callback = props[handlerNameByEvent[key] as keyof IdeomniScrollbarsProps] as (T: HTMLDivElement) => void;
...
export default IdeomniScrollbars;
