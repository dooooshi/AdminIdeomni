import { IdeomniThemeType } from '@ideomni/core/IdeomniSettings/IdeomniSettings';
import { createTheme, getContrastRatio, Theme, ThemeOptions } from '@mui/material/styles';
import _ from 'lodash';
import { defaultThemeOptions, extendThemeWithMixins, mustHaveThemeOptions } from '@ideomni/default-settings';
import { darkPaletteText, lightPaletteText } from '@/configs/themesConfig';
import useIdeomniSettings from './useIdeomniSettings';

type Direction = 'ltr' | 'rtl';

// Function to generate the MUI theme
const generateMuiTheme = (theme: IdeomniThemeType, direction: Direction, prefix?: string): Theme => {
...
export const changeThemeMode = (theme: IdeomniThemeType, mode: 'dark' | 'light'): IdeomniThemeType => {
	const modes = {
		dark: {
			palette: {
				mode: 'dark',
