...
import { IdeomniThemeType } from '../IdeomniSettings';
...
type PaletteSelectorProps = {
	...
	value: IdeomniThemeType;
	onChange: (value: IdeomniThemeType) => void;
};
...
function PaletteSelector(props: PaletteSelectorProps) {
	...
	const methods = useForm<IdeomniThemeType>({
		defaultValues: {},
		mode: 'onChange'
	});
	...
	function onSubmit(formData: IdeomniThemeType) {
		onChange(formData);
		handleCloseDialog();
	}
