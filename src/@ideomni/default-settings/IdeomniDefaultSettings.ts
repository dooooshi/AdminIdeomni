...
import { ideomniDark } from '@ideomni/colors';
...
/**
 * The defaultSettings object defines the default settings for the Ideomni application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Ideomni application.
 * It returns a IdeomniSettingsConfigType object that can be used to configure the application.
 */
export function getParsedQuerySettings(): IdeomniSettingsConfigType | object {
	...
	if (typeof defaultSettings === 'string') {
		...
		return JSON.parse(defaultSettings) as IdeomniSettingsConfigType;
	}
