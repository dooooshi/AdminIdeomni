...
const tableIcons: Partial<MRT_Icons> = {
	...
	ClearAllIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:adjustments-horizontal</IdeomniSvgIcon>,
	DensityLargeIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:bars-3-bottom-left</IdeomniSvgIcon>,
	DensityMediumIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:bars-3</IdeomniSvgIcon>,
	DensitySmallIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:bars-2</IdeomniSvgIcon>,
	DragHandleIcon: () => (
		<IdeomniSvgIcon
			className="rotate-45"
			size={14}
	...
	FilterListOffIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:funnel</IdeomniSvgIcon>,
	FullscreenExitIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:arrows-pointing-in</IdeomniSvgIcon>,
	FullscreenIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:arrows-pointing-out</IdeomniSvgIcon>,
	SearchIcon: (props) => (
		<IdeomniSvgIcon
			color="action"
			size={20}
	...
	SearchOffIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:magnifying-glass</IdeomniSvgIcon>,
	ViewColumnIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:view-columns</IdeomniSvgIcon>,
	MoreVertIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:ellipsis-vertical</IdeomniSvgIcon>,
	MoreHorizIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:ellipsis-horizontal</IdeomniSvgIcon>,
	SortIcon: (props) => (
		<IdeomniSvgIcon
			size={20}
			{...props}
	...
	VisibilityOffIcon: () => <IdeomniSvgIcon size={20}>heroicons-outline:eye-slash</IdeomniSvgIcon>
};
