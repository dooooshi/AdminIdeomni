...
const StyledPanel = styled(IdeomniScrollbars)<StyledPanelProps>(({ theme }) => ({
	backgroundColor: theme.vars.palette.background.default,
	color: theme.vars.palette.text.primary,
...
function NavbarStyle3Content(props: NavbarStyle3ContentProps) {
	...
	const [selectedNavigation, setSelectedNavigation] = useState<IdeomniNavItemType[]>([]);
	...
	function handleParentItemClick(selected: IdeomniNavItemType) {
