				...
				<List>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<IdeomniSvgIcon>material-outline:notifications</IdeomniSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<IdeomniSvgIcon>material-outline:cloud</IdeomniSvgIcon>
						</ListItemIcon>
					...
					<ListItem>
						<ListItemIcon className="min-w-9">
							<IdeomniSvgIcon>material-outline:brightness_high</IdeomniSvgIcon>
						</ListItemIcon>
