...
import { IdeomniLayoutProps } from '@ideomni/core/IdeomniLayout/IdeomniLayout';
import IdeomniLayout from '@ideomni/core/IdeomniLayout';
import { useMemo } from 'react';
import themeLayouts from './theme-layouts/themeLayouts';

type MainLayoutProps = Omit<IdeomniLayoutProps, 'layouts'> & {
	navbar?: boolean;
	toolbar?: boolean;
	footer?: boolean;
