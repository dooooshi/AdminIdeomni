			...
			<div className="flex flex-col sm:flex-row flex-auto sm:items-center min-w-0 p-6 md:p-8 pb-0 md:pb-0">
				...
				<div className="flex items-center mt-6 sm:mt-0 sm:mx-2 space-x-2">
					<Button
						...
						startIcon={<IdeomniSvgIcon size={20}>heroicons-solid:document-chart-bar</IdeomniSvgIcon>}
						variant="contained"
						color="primary"
					>
						Reports
					...
					<Button
						...
						variant="contained"
						color="secondary"
						startIcon={<IdeomniSvgIcon size={20}>heroicons-solid:arrow-up-tray</IdeomniSvgIcon>}
					>
						Export
					</Button>
				</div>
