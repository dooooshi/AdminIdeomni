...
import DemoContent from '@ideomni/core/DemoContent';
			...
			<div className="flex flex-col w-full max-w-6xl">
				...
				<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-10 pt-8 border-t">
					...
					<div className="flex items-center mt-2 sm:mt-0">
						...
						<IconButton>
							<IdeomniSvgIcon>heroicons-outline:thumb-up</IdeomniSvgIcon>
						</IconButton>
						<IconButton>
							<IdeomniSvgIcon>heroicons-outline:thumb-down</IdeomniSvgIcon>
						</IconButton>
					</div>
				</div>
				...
				<Card className="mt-8 flex items-center justify-between p-6 sm:px-10 rounded-xl shadow-sm hover:shadow-lg transition-shadow ease-in-out duration-150">
					...
					<IdeomniSvgIcon className="ml-3">heroicons-outline:arrow-right</IdeomniSvgIcon>
				</Card>
			</div>
		</div>
	);
