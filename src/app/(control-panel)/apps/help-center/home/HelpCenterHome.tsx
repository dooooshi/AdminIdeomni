...
import { useMainThemeDark } from '@ideomni/core/IdeomniSettings/hooks/IdeomniThemeHooks';
							...
							<OutlinedInput
								...
								startAdornment={
									<InputAdornment position="start">
										<IdeomniSvgIcon color="disabled">heroicons-solid:magnifying-glass</IdeomniSvgIcon>
									</InputAdornment>
								}
								slotProps={{
									input: {
