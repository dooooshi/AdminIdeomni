			...
			>
				{list.map((faq) => (
					...
					>
						...
						>
							<AccordionSummary expandIcon={<IdeomniSvgIcon>heroicons-outline:chevron-down</IdeomniSvgIcon>}>
								<div className="flex items-center py-1">
									<IdeomniSvgIcon color="action">heroicons-outline:question-mark-circle</IdeomniSvgIcon>
